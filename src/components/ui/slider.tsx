...
/**
 * shadcn-pattern Slider — Radix primitive styled with theme-aware Tailwind
 * utilities. Track uses --bg-card-dark, range uses --accent, thumb is a
 * solid pill with theme primary border.
 */
